...
namespace ptstemmer.implementations
{
	...
	public class OrengoStemmer: Stemmer
	{
		...
		public void readRulesFromXML()
		{
			...
			try{
				//var test = System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("OrengoStemmerRules.xml");
				
				doc.Load(@"E:\vitor_desktop\iCybersec\C#\PTStemmer-2.0-.NET\src\ptstemmer\implementations\OrengoStemmerRules.xml");
			}
			catch(Exception e) {
